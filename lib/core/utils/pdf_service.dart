...
class PdfService {
  static Future<void> generateAndShare(Transaction transaction, Person person) async {
    ...
    await Share.shareXFiles([xFile], text: 'Len Den Receipt for ${person.name}', subject: 'Payment Receipt');
  }
}
