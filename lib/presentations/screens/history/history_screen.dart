...
class HistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final transactions = ref.watch(transactionProvider).transactions.where((t) => t.personId == arg.personId).toList().reversed.toList();
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: IconButton(icon: Icon(Icons.picture_as_pdf), onPressed: () => _generatePdf(context, t, person)),
            leading: Icon(t.isPayment ? Icons.arrow_downward : Icons.arrow_upward, color: t.isPayment ? Colors.green : Colors.red),
          );
        },
      ),
    );
